...
The swamp-golang-starter project has strict rules for AI usage:
...
These rules apply only to outside contributions to swamp-golang-starter. Maintainers
...
Please remember that swamp-golang-starter is maintained by humans.
...
swamp-golang-starter is written with plenty of AI assistance, and many maintainers
